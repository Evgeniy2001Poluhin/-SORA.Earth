...
**Запроса, устанавливающего происхождение, не существует.** Прежняя версия этого
...
ревизия её создала. Происхождение берётся вне базы: из записи о развёртывании или
журнала аудита, показывающего, какие ревизии эта база выполняла. Если такой записи
