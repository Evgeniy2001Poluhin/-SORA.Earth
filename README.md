...
**Ни одного снимка в репозитории нет.** `docs/screenshots/` содержит только
описания: восемь разделов с подписями и привязку к главам диплома — и ноль
файлов. Из семи названных там имён шесть не существуют нигде; седьмое,
`02-evaluate.png`, принадлежит другому набору. В истории git этих файлов не
было ни разу, так что восстановить их из репозитория нельзя (#297).

Эта строка обещала «9 thesis-grade артефактов с подписями» и вела на документ,
описывающий девять несуществующих картинок — первое, что открывал читатель,
пришедший за доказательствами.

- Описания и что на каждом снимке должно быть:
  [docs/screenshots/README.md](docs/screenshots/README.md)
- Что действительно лежит в репозитории: `assets/screenshots/` — семь снимков
  DEMO-сценария, [docs/DEMO.md](docs/DEMO.md)
