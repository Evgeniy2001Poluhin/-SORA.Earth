...
@router.post("/full-pipeline", response_model=AIActionResponse)
def ai_trigger_full_pipeline(_admin=Depends(require_admin)):
    from app.scheduler import full_pipeline_run
    try:
        result = full_pipeline_run(trigger_source="ai_agent")
        return AIActionResponse(
